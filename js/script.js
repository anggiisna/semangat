                ...
                Swal.fire('Semangat terus ya kamu :)').then((result) => {
                  Swal.fire(
                    ...
                    Swal.fire(
                      ...
                      Swal.fire('Kalo ada apa-apa jangan ga enakan buat cerita yaa').then((result) => {
                        Swal.fire({
                          title: 'Oh iya aku mau nanya',
                          text: 'Ada sesuatu yang lagi kamu pingin ga?',
                          showDenyButton: true,
                          confirmButtonText: `Ada dongg`,
                          ...
                          if (result.isConfirmed) {
                            Swal.fire({
                              title: 'Mau apa?',
                              input: 'text',
                              inputPlaceholder: 'ex: Seblak, Duit 1 milyar, or etc',
                              ...
                              Swal.fire('Okey dehh', 'Nanti aku kabulin kemauan kamu yaa', 'success').then((result) => {
                                Swal.fire("Jaga Kesehatan yaaaa").then((result) => {
                                  selesai()
                                });
                              })
                            })
                            ...
                            Swal.fire('Oh okedeh kalo ga ada').then((result) => {
                              Swal.fire('Jaga Kesehatan yaaa').then((result) => {
                                selesai()
                              });
                            })
                          }
